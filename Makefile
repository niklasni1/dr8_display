...
STM_DIR=/home/niklas/code/STM32F4xx_DSP_StdPeriph_Lib_V1.1.0
...
# The tool we use
## all were prefixed with TOOLS_DIR nn
...
# Flash the STM32F4
flash: 
	/usr/bin/st-flash write $(PROJ_NAME).bin 0x8000000
